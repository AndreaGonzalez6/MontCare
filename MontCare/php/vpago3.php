...
if (mysqli_num_rows($validar_login) > 0) {
    ...
    setTimeout(function() {
        window.location = "http://localhost/MontCare/portaldepagos3.php?formulario1Completado=true";
    }, 200); 
</script>';
    ...
    <script>
        ...
        setTimeout(function() {
            window.location = "http://localhost/MontCare/portaldepagos3.php?formulario1Completado=false";
        }, 200); 
    </script>
    ';
}
