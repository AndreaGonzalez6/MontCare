    ...
    <div class="container-1">
        ...
        <main class="content">
          ...
          <div class="container-fluid colorg">
            <div class="row forma">
              <div class="col-lg-3">
                <a href="http://localhost/MontCare/" class="text-decoration-none">
          ...
          <div class="contenedor_planes">
            <div class="planes planes_laterales">
              ...
              <div class="parrafos-planes">
                <p class="p-planes contenedor_price cursive_font"><i class="fa-solid fa-x margin_X"
                    style="color: #a82610;"></i>Chat</p>
              </div>
              <div class="contenedor_price">
                ...
                <button type="submit" data-bs-toggle="modal" data-bs-target="#exampleModal1"
                  class="btn btn-danger xd cursive_font">
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="http://localhost/MontCare/index.php"> <button type="button"
                          class="btn btn-primary">Registrarme</button></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="planes">
              ...
              <div class="parrafos-planes">
                <p class="p-planes contenedor_price cursive_font"><i class="fa-solid fa-check margin_X"
                    style="color: #1e7406;"></i>Chat</p>
              </div>
              <div class="contenedor_price">
                <a href="planes.html">
                  <button type="button" class="btn btn-planes btn-warning xd cursive_font">
                ...
                <button type="button" class="btn btn-danger xd cursive_font" data-bs-toggle="modal"
