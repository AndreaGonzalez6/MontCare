...
<body>
    ...
    <div class="container">
        ...
        <div class="row margin">
            <div class="col-md-2">
                <img src="imágenes/cara de niño.png" class="cara_niño" alt="cara_niño" style="height: 22vh;">
            </div>
            <div class="col-md-3">
                <!--Formulario 1 -->
                <form action="php/vpago1.php" method="POST">
        ...
        <div class="row" id="formulario2" style="display: none">
            <form action="php/rpago1.php" method="POST">
                <div class="mb-3">
                    <label for="">Usuario (persona que tendra el plan)* </label>
                    <input type="text" class="espaciado" name="usuario" required>
                </div>
                <div class="mb-3">
                    <label for="">Nombre del propietario de la tarjeta* </label>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="numeroTarjeta" class="espaciado" placeholder="1234 5678 1234 5678" required>
                </div>
                <div class="mb-3">
